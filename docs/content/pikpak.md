...
Check the resource of url

```console
rclone backend checkurl remote: [options] [<arguments>+]
```

This command is used to check the status of resources on the server.
...
Request redeem for the current account

```console
rclone backend redeem remote: [options] [<arguments>+]
```

This command requests redeem for the current account.
