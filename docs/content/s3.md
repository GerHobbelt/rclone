...
See: https://github.com/artpar/artpar/issues/4673, https://github.com/artpar/artpar/issues/3631
...
This results in the following configuration being stored in `~/.config/artpar/rclone.conf`:
