...
```
      --115-app-id string                                   Custom App ID for authentication (default "100195125")
      --115-censored-only                                   Only show files that are censored (only applies to traditional API calls)
      --115-chunk-size SizeSuffix                           Chunk size for multipart uploads (default 5Mi)
      --115-contimeout Duration                             Connect timeout (default 10s)
      --115-cookie string                                   Provide the login cookie in the format "UID=...; CID=...; SEID=...;"
      --115-description string                              Description of the remote
      --115-dual-stack                                      Use a dual-stack (IPv4/IPv6) OSS endpoint for uploads
      --115-encoding Encoding                               The encoding for the backend (default LtGt,DoubleQuote,Ctl,LeftSpace,RightSpace,InvalidUtf8)
      --115-fast-upload                                     Upload strategy:
      --115-hash-memory-limit SizeSuffix                    Files bigger than this will be cached on disk to calculate hash if required (default 10Mi)
      --115-internal                                        Use the internal OSS endpoint for uploads (requires appropriate network access)
      --115-list-chunk int                                  Size of listing chunk (default 1150)
      --115-max-upload-parts int                            Maximum number of parts in a multipart upload (default 10000)
      --115-no-buffer                                       Skip disk buffering for uploads
      --115-no-check                                        Disable post-upload check (avoids extra API call but reduces certainty)
      --115-nohash-size SizeSuffix                          Files smaller than this size will use traditional streamed upload if fast_upload is enabled or if hash upload is not attempted/fails. Max is 5GiB (default 100Mi)
      --115-only-stream                                     Use traditional streamed upload (sample upload) for all files up to 5GiB. Fails for larger files
      --115-pacer-min-sleep Duration                        Minimum time to sleep between API calls (controls global QPS, default 5 QPS) (default 300ms)
      --115-prefetch                                        Prefetch download URLs for files queued for transfer
      --115-receive-code string                             Password from share link (for accessing shared files via traditional API)
      --115-root-folder-id string                           ID of the root folder
      --115-share-code string                               Share code from share link (for accessing shared files via traditional API)
      --115-timeout Duration                                IO idle timeout (default 45s)
      --115-upload-cutoff SizeSuffix                        Cutoff for switching to multipart upload (default 200Mi)
      --115-upload-hash-only                                Attempt hash-based upload (秒传) only. Skip uploading if the server doesn't have the file
      --115-user-agent string                               HTTP user agent. Primarily used for initial login mimicry (default "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36")
      --alias-description string                            Description of the remote
      --alias-remote string                                 Remote or path to alias
      --alist-cf-server string                              URL of the Cloudflare server
      --alist-description string                            Description of the remote
      --alist-encoding Encoding                             The encoding for the backend (default Slash,LtGt,Ctl,LeftSpace,RightSpace,InvalidUtf8)
      --alist-meta-pass string                              Meta password for listing
      --alist-otp-code string                               Two-factor authentication code
      --alist-pacer-min-sleep Duration                      Minimum sleep time between API requests (default 50ms)
      --alist-password string                               Password for AList (obscured)
      --alist-root-path string                              Root path within the AList server (default "/")
      --alist-url string                                    URL of the AList server
      --alist-user-agent string                             Custom User-Agent string to use (overridden by Cloudflare if cf_server is set)
      --alist-username string                               Username for AList
  ...
  -c, --checksum                                            Check for changes with size & checksum (if available, or fallback to size only)
      ...
      --clouddrive-description string                       Description of the remote
      --clouddrive-download-host string                     Override host:port used to build download URLs. Defaults to the gRPC server host:port
      --clouddrive-insecure                                 Allow plaintext gRPC connection (no TLS)
      --clouddrive-server string                            CloudDrive2 gRPC server address (host:port)
      --clouddrive-timeout Duration                         Dial timeout for gRPC connections (default 30s)
      --clouddrive-token string                             API token or JWT. Leave blank to fetch using user/pass (obscured)
  ...
  -L, --copy-links                                          Follow symlinks and copy the pointed to item
      ...
      --drive-activity-sleep Duration                       Sleep duration between Drive Activity requests (per target) (default 1s)
      --drive-activity-targets string                       Comma-separated list of folder IDs to monitor for file/directory changes using Drive Activity API
      ...
      --drive-gds-apikey string                             apikey for custom google drive authentication server
      --drive-gds-endpoint string                           api endpoint for custom google drive authentication server
      --drive-gds-mode string                               api mode for custom google drive authentication server (default "default")
      --drive-gds-userid string                             userid for custom google drive authentication server
      --drive-impersonate string                            Impersonate this user when using a service account
      --drive-impersonate-list string                       A list of names to be used for impersonation
      ...
      --drive-service-account-file-path string              Service Account Credentials JSON folder path
      --drive-service-account-max-load int                  Maximum number of loads for service account (default 5)
      --drive-service-account-min-sleep Duration            Minimum time to sleep between change service account (default 100ms)
      --drive-service-account-per-file                      Changes service account for each file copy
  ...
  -l, --links                                               Translate symlinks to/from regular files with a '.rclonelink' extension
      ...
      --mega-use-ipv6                                       Use multiple IPv6 addresses to bypass bandwidth limits
  ...
  -x, --one-file-system                                     Don't cross filesystem boundaries (unix/macOS only)
      ...
      --pass string                                         Password used to request token when token is empty (obscured)
  ...
  -q, --quiet                                               Print as little stuff as possible
      ...
      --totp string                                         Optional TOTP/recovery code when account has 2FA enabled
  ...
  -u, --update                                              Skip files that are newer on the destination
      ...
      --user string                                         Username used to request token when token is empty
      --user-agent string                                   Set the user-agent to a specified string (default "rclone/v1.70.0-35")
